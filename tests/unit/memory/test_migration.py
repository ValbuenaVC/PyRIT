...
def test_step_identifier_migration_metadata():
    ...
    assert mod.down_revision == "9c8b7a6d5e4f"
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            with engine.begin() as connection:
                ...
                # Stop just before the step_identifier migration: no column yet. Step_identifier
                # now chains after the attribution migration (9c8b7a6d5e4f) since both originally
                # branched off 7a1b2c3d4e5f and were serialized at merge time.
                command.upgrade(config, "9c8b7a6d5e4f")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            with engine.begin() as connection:
                ...
                command.downgrade(config, "9c8b7a6d5e4f")
